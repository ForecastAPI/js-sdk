 ...
 * @module ForecastAPI/model/ErrorResponse
 * @version 2.0.0
 */
class ErrorResponse {
    /**
     * Constructs a new <code>ErrorResponse</code>.
     * @alias module:ForecastAPI/model/ErrorResponse
     */
    constructor() { 
     ...
     * @param {module:ForecastAPI/model/ErrorResponse} obj Optional instance to populate.
     * @return {module:ForecastAPI/model/ErrorResponse} The populated <code>ErrorResponse</code> instance.
     */
