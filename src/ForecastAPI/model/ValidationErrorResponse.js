 ...
 * @module ForecastAPI/model/ValidationErrorResponse
 * @version 2.0.0
 */
class ValidationErrorResponse {
    /**
     * Constructs a new <code>ValidationErrorResponse</code>.
     * @alias module:ForecastAPI/model/ValidationErrorResponse
     */
    constructor() { 
     ...
     * @param {module:ForecastAPI/model/ValidationErrorResponse} obj Optional instance to populate.
     * @return {module:ForecastAPI/model/ValidationErrorResponse} The populated <code>ValidationErrorResponse</code> instance.
     */
