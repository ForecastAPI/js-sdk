...
* @alias module:ForecastAPI/ApiClient
* @class
*/
class ApiClient {
    /**
    ...
    * @param {module:ForecastAPI/ApiClient.CollectionFormatEnum} collectionFormat The array element separator strategy.
    ...
    * @callback module:ForecastAPI/ApiClient~callApiCallback
    ...
    * @param {module:ForecastAPI/ApiClient~callApiCallback} callback The callback function.
...
* @type {module:ForecastAPI/ApiClient}
*/
