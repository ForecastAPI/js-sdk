...
(function(root, factory) {
  ...
  describe('HealthApi', function() {
    describe('getApiRoot', function() {
      it('should call getApiRoot successfully', function(done) {
        //uncomment below and update the code to test getApiRoot
        //instance.getApiRoot(function(error) {
