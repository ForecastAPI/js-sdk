...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ForecastAPI.BatchPresignResponse();
  });
  ...
  describe('BatchPresignResponse', function() {
    it('should create an instance of BatchPresignResponse', function() {
      // uncomment below and update the code to test BatchPresignResponse
      //var instance = new ForecastAPI.BatchPresignResponse();
      //expect(instance).to.be.a(ForecastAPI.BatchPresignResponse);
    });
