...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ForecastAPI.ValueBounds();
  });
  ...
  describe('ValueBounds', function() {
    it('should create an instance of ValueBounds', function() {
      // uncomment below and update the code to test ValueBounds
      //var instance = new ForecastAPI.ValueBounds();
      //expect(instance).to.be.a(ForecastAPI.ValueBounds);
    });
