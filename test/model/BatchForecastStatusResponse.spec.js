...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ForecastAPI.BatchForecastStatusResponse();
  });
  ...
  describe('BatchForecastStatusResponse', function() {
    it('should create an instance of BatchForecastStatusResponse', function() {
      // uncomment below and update the code to test BatchForecastStatusResponse
      //var instance = new ForecastAPI.BatchForecastStatusResponse();
      //expect(instance).to.be.a(ForecastAPI.BatchForecastStatusResponse);
    });
